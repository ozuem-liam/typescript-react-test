...
function NavBar() {
  ...
  <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-4">
    <div className="relative flex items-center justify-between h-16 mb-28">
      ...
      <div className="p-2 rounded-xl flex items-center justify-center sm:items-stretch sm:justify-start">
          <h1 className="text-xl mb-0">AR SHARKIR</h1>
      </div>

      <ul className="p-2 m-0 bg-white rounded-xl flex items-center justify-center sm:items-stretch sm:justify-start">
